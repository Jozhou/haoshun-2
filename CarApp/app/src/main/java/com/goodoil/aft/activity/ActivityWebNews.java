...
import com.goodoil.aft.view.news.NewsWebView;
...
public class ActivityWebNews extends BaseActivity {
	...
	private NewsWebView webContent;
	...
	protected void onQueryArguments(Intent intent) {
		...
		newsEntry = (NewsEntry) getIntent().getSerializableExtra(IntentCode.INTENT_NEWS_ITEM);
	}
	...
	protected void onApplyData() {
		...
		webContent.setNewsEntry(newsEntry);
	}
