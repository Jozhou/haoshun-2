...
public class FrameLayout extends android.widget.FrameLayout implements ILoadingLayout {
	...
	protected android.widget.FrameLayout ContentView;
	...
	protected void setContentView(AttributeSet attrs) {
		...
		if(contentResId != 0) {
			ContentView = (android.widget.FrameLayout) LayoutInflater.from(mContext).inflate(contentResId, null, false);
		}
		if(ContentView == null) {
			ContentView = getLayoutView();
		}
		if(ContentView == null) {
			ContentView = new android.widget.FrameLayout(mContext);
		}
	 ...
	 * @return
	 */
	protected android.widget.FrameLayout getLayoutView() {
		return null;
	}
