 ...
 */
package com.corelibrary.view.viewflow;
...
public class ViewFlow extends AdapterView<Adapter> {
	...
	private static final int FLOW_INTERVAL = 3 * 1000;
	private AutoFlowHandler mHandler;
	private int timeSpan = FLOW_INTERVAL;
...
//		return mAdapter.getCount();
	...
	public void setSideBuffer(int slideBuffer) {
		this.mSideBuffer = slideBuffer;
	}

	public void startAutoFlowTimer(){
		if (mHandler == null) {
			mHandler = new AutoFlowHandler();
		} else {
			stopAutoFlowTimer();
		}
		Message message = mHandler.obtainMessage(0);
		mHandler.sendMessageDelayed(message, timeSpan);
	}
	...
	class AutoFlowHandler extends Handler {
		@Override
