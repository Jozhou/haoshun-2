...
/**
 * Grid分割线，同SimpleGridItemDecoration，区别在于可设置分割线颜色及形状
 */
public class SimpleGridItemDecorationWithColor extends SimpleGridItemDecoration {

    public SimpleGridItemDecorationWithColor(Context context, int res) {
        super(context, res);
    }
